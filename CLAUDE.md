...
## Debugging on device
- **Diagnostics overlay:** tap the "App build" row in Settings → live panel with scroll offsets, visual-viewport geometry, focus state, touch-hit logging, and keyboard-guard events. Tap the panel to close.
